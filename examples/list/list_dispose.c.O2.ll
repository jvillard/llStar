...
.lr.ph:                                           ; preds = %.lr.ph, %0
  %.04 = phi %struct.node* [ %3, %.lr.ph ], [ %l, %0 ]
  tail call void @llvm.dbg.value(metadata !{%struct.node* %.04}, i64 0, metadata !18), !dbg !23
  %2 = getelementptr inbounds %struct.node* %.04, i64 0, i32 1, !dbg !25
  %3 = load %struct.node** %2, align 8, !dbg !25, !tbaa !26
  tail call void @llvm.dbg.value(metadata !{%struct.node* %3}, i64 0, metadata !17), !dbg !25
  %4 = bitcast %struct.node* %.04 to i8*, !dbg !29
  tail call void @free(i8* %4) #1, !dbg !29
  %5 = icmp eq %struct.node* %3, null, !dbg !22
  br i1 %5, label %._crit_edge, label %.lr.ph, !dbg !22
...
!0 = metadata !{i32 786449, i32 0, i32 12, metadata !"list_dispose.c", metadata !"/home/jvillard/science/tools/llstar/bitbucket/examples/list", metadata !"Debian clang version 3.2-11 (tags/RELEASE_32/final) (based on LLVM 3.2)", i1 true, i1 true, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !1}
!1 = metadata !{metadata !2}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{metadata !5}
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"list_dispose", metadata !"list_dispose", metadata !"", metadata !6, i32 8, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, void (%struct.node*)* @list_dispose, null, null, metadata !15, i32 8}
...
!18 = metadata !{i32 786688, metadata !19, metadata !"prev", metadata !6, i32 9, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [prev] [line 9]
!19 = metadata !{i32 786443, metadata !5, i32 8, i32 0, metadata !6, i32 0} ; [ DW_TAG_lexical_block ] [/]
!20 = metadata !{i32 8, i32 0, metadata !5, null}
!21 = metadata !{i32 9, i32 0, metadata !19, null}
!22 = metadata !{i32 10, i32 0, metadata !19, null}
!23 = metadata !{i32 11, i32 0, metadata !24, null}
!24 = metadata !{i32 786443, metadata !19, i32 10, i32 0, metadata !6, i32 1} ; [ DW_TAG_lexical_block ] [/]
...
!29 = metadata !{i32 13, i32 0, metadata !24, null}
!30 = metadata !{i32 15, i32 0, metadata !19, null}
